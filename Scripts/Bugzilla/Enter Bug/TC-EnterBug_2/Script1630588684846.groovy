...
WebUI.selectOptionByIndex(findTestObject('Page_Enter Bug TestProduct/Severity'), 2)
...
WebUI.sendKeys(findTestObject('Page_Enter Bug TestProduct/input_Summary_short_desc'), 'Submit Bug')
...
WebUI.sendKeys(findTestObject('Page_Enter Bug TestProduct/DescriptionFile'), '')
...
if (WebUI.verifyTextPresent('You must enter a Description for this attachment.', false) == true) {
	
    WebUI.delay(2)

    WebUI.takeScreenshot('D:\\Dirman\\KatalonToyota\\Capture\\Enter Bug\\EnterBug_2.png')
